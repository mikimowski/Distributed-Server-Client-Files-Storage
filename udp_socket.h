...
public:
    ...
    void send(const SimpleMessage& message, const std::string& destination_ip, in_port_t destination_port, uint16_t data_length = 0);
    ...
    std::tuple<ComplexMessage, ssize_t, struct sockaddr_in> recvfrom();
};
